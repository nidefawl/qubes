...
import nidefawl.qubes.font.TextInputRenderer;
...
public class TextField extends AbstractUI implements Renderable {
    ...
    private TextInputRenderer inputRenderer;

    public TextField(int id, String text) {
        this.id = id;
        this.text = text;
        this.font = FontRenderer.get("Arial", 18, 0, 20);
        this.inputRenderer = new TextInputRenderer(this.font);
        this.focused = false;
    }
