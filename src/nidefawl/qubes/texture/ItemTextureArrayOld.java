...
//
//public class ItemTextureArrayOld {
//    public static final int ITEM_TEXTURE_BITS = 4;
//    static final ItemTextureArray instance = new ItemTextureArray();
//    HashMap<Integer, ArrayList<AssetTexture>> lastLoaded = new HashMap<>();
//    public static ItemTextureArray getInstance() {
//        return instance;
//    }
//
//    
...
//        float progress = 0f;
//        int totalBlocks = Item.getRegisteredIDs().length;
//        int nBlock = 0;
//        for (int i = 0; i < len; i++) {
//            Item b = items[i];
//            if (b != null) {
...
//        this.textures = new int[Item.NUM_ITEMS<<ITEM_TEXTURE_BITS];
...
//            );
//            Engine.checkGLError("glTexStorage3D "+glid_color);
//        }
