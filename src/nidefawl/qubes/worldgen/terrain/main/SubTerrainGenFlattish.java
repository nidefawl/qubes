 ...
 */
public class SubTerrainGenFlattish extends SubTerrainGen {
    /**
     * @author Michael Hept 2015
     * Copyright: Michael Hept
     */
    ...
    public SubTerrainGenFlattish(TerrainGeneratorLight t) {
        this.main = t;
...
//        double caveStrength = 2000D;
        ...
        double tallness = 3.8D;
        double tallnessBase = 0.35D;
        double heightOffset = 17.0D;
        double dStr = 44.0D;
        double yBrr = 110;
        double yBrr2 = 115;
        double brrrIntens = 0.4;
