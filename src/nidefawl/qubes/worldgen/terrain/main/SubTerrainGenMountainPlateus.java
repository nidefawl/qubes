 ...
 */
public class SubTerrainGenMountainPlateus extends SubTerrainGen {
    /**
     * @author Michael Hept 2015
     * Copyright: Michael Hept
     */
    ...
    public SubTerrainGenMountainPlateus(TerrainGeneratorMain t) {
        this.main = t;
 ...
 */
        ...
        double scaleMixXZ = 1.50D;
        double scaleMixY = scaleMixXZ*0.7D;
        double scaleT1XZ = 3.7D;
        double scaleT1Y = scaleT1XZ*0.01D;
        double scaleT2XZ =3.6D;
        double scaleT2Y = scaleT1XZ*0.1;
        double scaleT5XZ =3.5D;
        double scaleT5Y = scaleT5XZ*4;
...
//        double caveStrength = 2000D;
        ...
        double randomHeight = 0.2D;
        double tallness = 8.4D;
        double tallnessBase = 0.05D;
        double heightOffset = 12.0D;
        double dStr = 24.0D;
        double yBrr = 110;
        double yBrr2 = 120;
        double brrrIntens = 0.4D;
        double brrrIntens2 = 0.23D;
        double riverY = 92;
        double riverY2 = riverY + 12;
        double riverStr = 0.8D;
...
//                dYH += dz;
            ...
            int idx = idx_xz + y;
            double dN1 = noise.dnoise_[idx] * 0.9D;
            ...
            double xr = 0;
            xr += dRiverH * dBlurred2 * dStr * coreScale*0.7*riverStr;
            xr += dRiverH2 * dBlurred * dStr * coreScale*3.7*riverStr;
            double dt = func2(110 + dN1 * 12, y, 4.4D) * 0.25;
            ...
            brrr -= clamp10(cavestr);
            brrr -= clamp10(dRiverH+dRiverH2);
            if (brrr < 0) brrr = 0;
            brrr2 -= clamp10(cavestr);
            brrr2 -= clamp10(dRiverH+dRiverH2);
            if (brrr2 < 0) brrr2 = 0;
