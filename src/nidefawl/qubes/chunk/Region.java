...
//import nidefawl.engine.DisplayList;
//
//import org.craftland.pixelmapserver.blockcolors.ColorizerGrass;
...
//        if (a > 0 && !Block.byId[a].isOpaqueCube()) {
//            return true;
//        }
//        return false;
//    }
...
//          float m = 1F;
//          float alpha = 1F;
//          if (Block.STATIONARY_WATER.id == block) {
//              alpha = 0.8F;
//          }
//            int c = color[block];
//
